                ...
                <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="form-label" for="employee_code">Emp Code *</label>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('campus') is-invalid @enderror"
                                           name="campus"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('designation') is-invalid @enderror"
                                           name="designation"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('department') is-invalid @enderror"
                                           name="department"
                            ...
                            <div class="col-6" id="image_input">
                                <div class="image-edit custom-file-button mb-3">
                                    ...
                                    <input disabled type="file" id="image-cropper" accept=".png, .jpg, .jpeg" name="image"
