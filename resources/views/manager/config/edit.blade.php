...
{{--                    @endcan--}}
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('key') is-invalid @enderror" name="key" id="key" onkeyup="listingslug(this.value)" placeholder="Key" value="{{(isset($data) ? $data->key : old('key'))}}">
                    @error('key')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('value') is-invalid @enderror" name="value" id="value" placeholder="Value" value="{{(isset($data) ? $data->value : old('value'))}}">
                    @error('value')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
