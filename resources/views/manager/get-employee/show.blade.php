    ...
    <div class="card mt-3">
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    <label class="form-label" for="emp_code">Code</label>
                    <input type="text" class="form-control @error('emp_code') is-invalid @enderror" name="emp_code" id="emp_code" placeholder="Code" value="{{(isset($data) ? $data->employee_code : old('employee_code'))}}" disabled>
                    @error('emp_code')
