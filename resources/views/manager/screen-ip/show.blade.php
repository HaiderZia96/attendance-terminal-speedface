        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input disabled type="text" class="form-control @error('ip') is-invalid @enderror"
                           name="ip"
                ...
                <div class="mb-3">
                    ...
                    <select class="select2-options-screen-type form-control @error('type') is-invalid @enderror" name="type" disabled>
...
{{--                    <select disabled class="select2-options-screen-id form-control @error('screen_id') is-invalid @enderror" name="screen_id"></select>--}}
{{--                    @error('screen_id')--}}
{{--                    <strong class="text-danger">{{ $message }}</strong>--}}
{{--                    @enderror--}}
{{--                </div>--}}
