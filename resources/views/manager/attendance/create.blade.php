                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('punch_time') is-invalid @enderror"
                                           name="punch_time"
                                           id="punch_time" placeholder="Punch Time" value="2024-01-15T08:00:00" step="1">
                                    @error('punch_time')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control @error('upload_time') is-invalid @enderror"
                                           name="upload_time"
                                           id="upload_time" placeholder="Upload Time" value="2024-01-15T08:00:00" step="1">
                                    @error('upload_time')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('area_alias') is-invalid @enderror"
                                           name="area_alias"
                                           id="area_alias" placeholder="Area Alias" value="{{old('area_alias')}}">
                                    @error('area_alias')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('terminal_sn') is-invalid @enderror"
                                           name="terminal_sn"
                                           id="terminal_sn" placeholder="Terminal Serial No." value="{{old('terminal_sn')}}">
                                    @error('terminal_sn')
                                    <strong class="text-danger">{{ $message }}</strong>
                                    @enderror
                                </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('terminal_alias') is-invalid @enderror"
                                           name="terminal_alias"
                                           id="terminal_alias" placeholder="Terminal Alias." value="{{old('terminal_alias')}}">
