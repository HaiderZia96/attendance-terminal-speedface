                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="employee_code">Employee Code *</label>
                                    <input disabled type="text" class="form-control @error('employee_code') is-invalid @enderror"
                                           name="employee_code"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="datetime-local" class="form-control @error('punch_time') is-invalid @enderror"
                                           name="punch_time"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="datetime-local" class="form-control @error('upload_time') is-invalid @enderror"
                                           name="upload_time"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('area_alias') is-invalid @enderror"
                                           name="area_alias"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('terminal_sn') is-invalid @enderror"
                                           name="terminal_sn"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input disabled type="text" class="form-control @error('terminal_alias') is-invalid @enderror"
                                           name="terminal_alias"
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <select disabled class="select2-options-in-out form-control @error('in_out') is-invalid @enderror" name="in_out">
