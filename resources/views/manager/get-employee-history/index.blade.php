        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                                        @can('manager_attendance_get-employee-history-delete-all')
...
{{--                                        <div class="col-3">--}}
{{--                                            <label>Status</label>--}}
{{--                                            <select class="select2-options-status form-control" name="status">--}}
{{--                                                <option value="">All</option>--}}
{{--                                                <option value="1"--}}
...
{{--                                                </option>--}}
{{--                                                <option value="0"--}}
{{--                                                        @if(request()->status == "0") selected @endif>Failed--}}
{{--                                                </option>--}}
{{--                                                <option value="2"--}}
{{--                                                        @if(request()->status == "2") selected @endif>Unknown--}}
{{--                                                </option>--}}
{{--                                            </select>--}}
{{--                                            <input type="hidden" value="{{request()->status}}"--}}
{{--                                                   id="status">--}}
{{--                                        </div>--}}
                                        <div class="col-6">
                                        ...
                                        <div class="col-12 ">
                                            <div class="float-end mt-2">
                                                ...
                                                <a href="{{route('manager.get-employee-histories.index')}}"
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type":"GET",
                    "url":"{{route('manager.get.get-employee-histories')}}",
                    "data": function (d) {
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render: function ( data, type, row, meta ) {
                            let URL = "{{ route('manager.get-employee-histories.destroy', ':id') }}";
                            URL = URL.replace(':id', row.id);

                            return '<div class="d-flex">' +

                                                               @can('manager_attendance_get-employee-history-delete')
