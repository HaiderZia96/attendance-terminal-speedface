...
class ProfileController extends Controller
{
    ...
    {
        $this->middleware('permission:manager_attendance_profile-edit', ['only' => ['edit','update']]);
    }
    /**
    ...
    public function edit($id)
    {
        if (auth()->user()->id == $id) {
            ...
            $data = [
                ...
                'p_description' => null,
                'method' => 'POST',
                'action' => route('manager.profile.update', $record->id),
...
//                'enctype' => 'application/x-www-form-urlencoded', // With attachment like file or images in form
            ...
            return view('manager.profile.edit')->with($data);
        }
        else{
            abort(404, 'NOT FOUND');
        }
